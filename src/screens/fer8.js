...
import {ScrollView ,StyleSheet,Button,TouchableOpacity} from 'react-native';
import { Container, Header, Content,CheckBox,ListItem,Body, Accordionm,Text, View ,Input} from "native-base";

export default function Fer8({navigation}) {
    ...
    return (
      <Container>
        ...
        <ListItem style={styles.list}  >
          ...
          <Button color='coral' title='Suivant' onPress={()=> navigation.navigate("point")} />
        </Content>
      </Container>
